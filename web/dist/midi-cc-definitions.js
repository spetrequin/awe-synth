...
let ccControlsCache = null;
/**
 * Get CC control definitions (loads from JSON config if not cached)
 */
export const getCCControlDefinitions = async () => {
    if (!ccControlsCache) {
        const result = await enhancedConfigLoader.loadConfig('midi-cc-controls');
 ...
 */
export const getControlByCC = async (ccNumber) => {
 ...
 */
export const getControlsByType = async (type) => {
    const controls = await getCCControlDefinitions();
 ...
 */
export const getControlsByCategory = async (category) => {
    const controls = await getCCControlDefinitions();
 ...
 */
export const getControlCategories = async () => {
    const controls = await getCCControlDefinitions();
...
//# sourceMappingURL=midi-cc-definitions.js.map