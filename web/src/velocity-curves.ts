...
export const VELOCITY_PROFILES = new Map<string, VelocityProfile>([
    ['linear', {
        name: 'Linear',
    ...
    ['organist', {
        ...
        curve: (n: number) => n < 0.3 ? n * 1.5 : 0.45 + (n - 0.3) * 0.78
    }]
]);

export class VelocityCurveProcessor {
    private currentProfile: string = 'natural';
    private sensitivity: number = 1.0;
    
    constructor(initialProfile: string = 'natural') {
     ...
     */
    public getCurrentProfile(): VelocityProfile | undefined {
