...
console.assert(validators.string()(
    'test', 'field', 'config'
) === 'test', 'String validator should pass valid string');
...
console.assert(validators.number(0, 127)(
    64, 'field', 'config'
) === 64, 'Number validator should pass valid number');

console.assert(validators.integer(0, 127)(
    100, 'field', 'config'
) === 100, 'Integer validator should pass valid integer');

// Test MIDI validators
console.assert(validators.midiProgram()(
    0, 'field', 'config'
) === 0, 'MIDI program 0 should be valid');

console.assert(validators.midiProgram()(
    127, 'field', 'config'
) === 127, 'MIDI program 127 should be valid');
